...
import { Upload, MapPin, Calendar, Tag, FileImage, X } from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              {/* <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-8">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-500 mb-4">PNG, JPG up to 5MB each (max 3 photos)</p>
                  <button
                    type="button"
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <ul className="space-y-2 text-blue-800">
            ...
            <li className="flex items-start">
              <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
              Be specific about brand, model, color, and distinguishing features
            </li>
            <li className="flex items-start">
              <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
              Pin the exact location where the item was lost or found
            </li>
            <li className="flex items-start">
              <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0"></span>
              Check back regularly for messages from other users
            </li>
          </ul>
        </div>
      </div>
